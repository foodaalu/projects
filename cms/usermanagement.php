    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php flash(); ?>
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800" style="font-size: 28px;font-weight: bold;"><em>Staff List</em>
          	<a href="usermanagement-form.php" class="btn btn-success float-right" style="border-radius: 5px;padding: 5px 15px; ">
          	<i class="fas fa-plus"></i>&nbspAdd Staff
          </a>
          </h1>
